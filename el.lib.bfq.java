...
function Library:create_ui()
    ...
    Pin.BackgroundColor3 = Color3.fromRGB(220, 20, 60)
    Pin.Parent = Handler
    ...
    Icon.ImageColor3 = Color3.fromRGB(220, 20, 60)
    ...
    Divider.BackgroundColor3 = Color3.fromRGB(220, 20, 60)
            ...
            if object == tab then
                if object.BackgroundTransparency ~= 0.3 then
                    ...
                    TweenService:Create(object.Icon, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                        ImageTransparency = 0,
                        ImageColor3 = Color3.fromRGB(220, 20, 60)
                    }):Play()
                end
    ...
    function self:create_tab(title: string, icon: string)
        ...
        function TabManager:create_module(settings: any)
            ...
            Module.Name = 'Module'
            Module.Size = UDim2.new(0, 241, 0, 95)
            ...
            Header.Name = 'Header'
            Header.Size = UDim2.new(0, 241, 0, 95)
            ...
            ModuleName.TextColor3 = Color3.fromRGB(220, 20, 60)
            ...
            Keybind.BackgroundColor3 = Color3.fromRGB(220, 20, 60)
            ...
            TextLabel.Size = UDim2.new(0, 30, 0, 14)
            TextLabel.BackgroundTransparency = 1
            ...
            function ModuleManager:change_state(state: boolean)
                ...
                if self._state then
                    TweenService:Create(Module, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                        Size = UDim2.fromOffset(241, 95 + self._size + self._multiplier)
                    }):Play()
            ...
            function ModuleManager:scale_keybind(empty: boolean)
                if Library._config._keybinds[settings.flag] and not empty then
                    ...
                    Keybind.Size = UDim2.fromOffset(font_size.X + 8, 16)
                    TextLabel.Size = UDim2.fromOffset(font_size.X + 4, 14)
                else
                    Keybind.Size = UDim2.fromOffset(35, 16)
                    TextLabel.Size = UDim2.fromOffset(30, 14)
                end
            end
            ...
            function ModuleManager:create_paragraph(settings: any)
                ...
                if ModuleManager._state then
                    Module.Size = UDim2.fromOffset(241, 95 + self._size)
                end
            ...
            function ModuleManager:create_text(settings: any)
                ...
                TextFrame.BackgroundTransparency = 0.05
            ...
            function ModuleManager:create_textbox(settings: any)
                ...
                Textbox.Size = UDim2.new(0, 207, 0, 16)
            ...
            function ModuleManager:create_checkbox(settings: any)
                ...
                KeybindBox.BackgroundColor3 = Color3.fromRGB(220, 20, 60)
                ...
                function CheckboxManager:change_state(state: boolean)
                    self._state = state
                    if self._state then
                        TweenService:Create(UIStroke, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                            Transparency = 0.3
                        }):Play()
            ...
            function ModuleManager:create_slider(settings: any)
                ...
                Drag.BackgroundTransparency = 0.05
                ...
                Value.TextColor3 = Color3.fromRGB(220, 20, 60)
            ...
            function ModuleManager:create_dropdown(settings: any)
                        ...
                        for _, object in Options:GetChildren() do
                            if object.Name == "Option" then
                                ...
                                if table.find(selected, object.Text) then
                                    ...
                                    object.TextColor3 = Color3.fromRGB(220, 20, 60)
                                else
                ...
                function DropdownManager:unfold_settings()
                    ...
                    if self._state then
                        ...
                        TweenService:Create(Module, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                            Size = UDim2.fromOffset(241, 95 + ModuleManager._size + ModuleManager._multiplier)
                        }):Play()
                ...
                if #settings.options > 0 then
                    ...
                    for index, value in settings.options do
                        ...
                        Option.MouseLeave:Connect(function()
                            if not table.find(Library._config._flags[settings.flag] or {}, value) then
                                TweenService:Create(Option, TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                                    TextColor3 = Color3.fromRGB(200, 200, 200)
                                }):Play()
                            end
            ...
            function ModuleManager:create_feature(settings)
                ...
                FeatureButton.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
                ...
                if not settings.disablecheck then
                    ...
                    Checkbox.BackgroundColor3 = checked and Color3.fromRGB(220, 20, 60) or Color3.fromRGB(25, 25, 25)
                    Checkbox.Text = ""
                ...
                FeatureButton.MouseEnter:Connect(function()
                    TweenService:Create(FeatureButton, TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                        BackgroundColor3 = Color3.fromRGB(35, 35, 35)
                    }):Play()
                    TweenService:Create(UIStroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                        Transparency = 0.5
